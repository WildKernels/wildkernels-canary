...
const devices = [
  ...
  },
  {
    ...
    osKernels: [
      { os: "OxygenOS 15", kernel: "android13-5.15.167" },
      { os: "OxygenOS 16", kernel: "android13-5.15.180" },
    ],
  },
  {
    name: "OnePlus Ace 2V",
  ...
  },
  {
    ...
    features: ["SusFS", "BBR", "BBG", "TTL", "IP_SET & IPv6NAT", "UnicodeFix", "NTSync"],
    osKernels: [
      { os: "OxygenOS 15", kernel: "android12-5.10.226" },
      { os: "OxygenOS 16", kernel: "android12-5.10.236" },
    ],
  },
  {
    ...
    features: ["SusFS", "BBR", "BBG", "TTL", "IP_SET & IPv6NAT", "UnicodeFix", "Droidspaces", "NTSync"],
    osKernels: [
      { os: "OxygenOS 14", kernel: "android14-6.1.75" },
      { os: "OxygenOS 15", kernel: "android14-6.1.118" },
      { os: "OxygenOS 16", kernel: "android14-6.1.118" },
    ],
  },
  {
    name: "OnePlus Ace 3V",
  ...
  },
  {
    ...
    osKernels: [
      { os: "OxygenOS 15", kernel: "android15-6.6.66" },
      { os: "OxygenOS 16", kernel: "android15-6.6.89" },
    ],
  },
  {
    ...
    features: ["SusFS", "BBR", "BBG", "TTL", "IP_SET & IPv6NAT", "UnicodeFix", "Droidspaces", "NTSync"],
    osKernels: [
      { os: "OxygenOS 15", kernel: "android14-6.1.115" },
      { os: "OxygenOS 16", kernel: "android14-6.1.134" },
    ],
  },
  {
    ...
    features: ["HMBIRD", "SusFS", "BBR", "BBG", "TTL", "IP_SET & IPv6 NAT", "Unicode Fix", "Droidspaces", "NTSync"],
    osKernels: [
      { os: "OxygenOS 15", kernel: "android15-6.6.89" },
      { os: "OxygenOS 16", kernel: "android15-6.6.89" },
    ],
  },
  {
    ...
    osKernels: [
      { os: "OxygenOS 15", kernel: "android14-6.1.118" },
      { os: "OxygenOS 16", kernel: "android14-6.1.141" },
    ],
  },
  {
    name: "OnePlus Ace 6T",
  ...
  },
  {
    ...
    features: ["SusFS", "BBR", "BBG", "TTL", "IP_SET & IPv6NAT", "UnicodeFix", "NTSync"],
    osKernels: [
      { os: "OxygenOS 14", kernel: "android12-5.10.168" },
      { os: "OxygenOS 15", kernel: "android12-5.10.209" },
    ],
  },
  {
    name: "OnePlus Ace",
  ...
  },
  {
    ...
    features: ["SusFS", "BBR", "BBG", "TTL", "IP_SET & IPv6NAT", "UnicodeFix", "Droidspaces", "NTSync"],
    osKernels: [
      { os: "OxygenOS 15", kernel: "android13-5.15.180" },
      { os: "OxygenOS 16", kernel: "android13-5.15.180" },
    ],
  },
  {
  ...
  },
  {
    ...
    features: ["SusFS", "BBR", "BBG", "TTL", "IP_SET & IPv6NAT", "UnicodeFix", "Droidspaces", "NTSync"],
    osKernels: [
      { os: "OxygenOS 15", kernel: "android14-6.1.75" },
      { os: "OxygenOS 16", kernel: "android14-6.1.118" },
    ],
  },
  {
  ...
  },
  {
    ...
    features: ["HMBIRD", "SusFS", "BBR", "BBG", "TTL", "IP_SET & IPv6 NAT", "Unicode Fix", "Droidspaces", "NTSync"],
    osKernels: [
      { os: "OxygenOS 15", kernel: "android15-6.6.57" },
      { os: "OxygenOS 16", kernel: "android15-6.6.89" },
    ],
  },
  {
  ...
  },
  {
    ...
    features: ["SusFS", "BBR", "BBG", "TTL", "IP_SET & IPv6NAT", "UnicodeFix", "Droidspaces", "NTSync"],
    osKernels: [
      { os: "Oxygen OS 15", kernel: "android14-6.1.128" },
      { os: "Oxygen OS 16", kernel: "android14-6.1.134" },
    ],
  },
  {
    ...
    features: ["HMBIRD", "SusFS", "BBR", "BBG", "TTL", "IP_SET & IPv6 NAT", "Unicode Fix", "Droidspaces", "NTSync"],
    osKernels: [
      { os: "Oxygen OS 15", kernel: "android15-6.6.57" },
      { os: "Oxygen OS 16", kernel: "android15-6.6.89" },
    ],
  },
  {
  ...
  },
  {
    ...
    features: ["SusFS", "BBR", "BBG", "TTL", "IP_SET & IPv6NAT", "UnicodeFix", "NTSync"],
    osKernels: [
      { os: "Oxygen OS 15", kernel: "android12-5.10.226" },
      { os: "Oxygen OS 16", kernel: "android12-5.10.236" },
    ],
  },
  {
    ...
    features: ["SusFS", "BBR", "BBG", "TTL", "IP_SET & IPv6NAT", "UnicodeFix", "Droidspaces", "NTSync"],
    osKernels: [
      { os: "Oxygen OS 14", kernel: "android14-6.1.75" },
      { os: "Oxygen OS 15", kernel: "android14-6.1.118" },
      { os: "Oxygen OS 16", kernel: "android14-6.1.118" },
    ],
  },
  {
  ...
  },
  {
    ...
    features: ["SusFS", "BBR", "BBG", "TTL", "IP_SET & IPv6NAT", "UnicodeFix", "NTSync"],
    osKernels: [
      { os: "Oxygen OS 14", kernel: "android12-5.10.209" },
      { os: "Oxygen OS 15", kernel: "android12-5.10.226" },
      { os: "Oxygen OS 16", kernel: "android12-5.10.236" },
    ],
  },
  {
    ...
    features: ["SusFS", "BBR", "BBG", "TTL", "IP_SET & IPv6NAT", "UnicodeFix", "NTSync"],
    osKernels: [
      { os: "Oxygen OS 14", kernel: "android12-5.10.168" },
      { os: "Oxygen OS 15", kernel: "android12-5.10.209" },
    ],
  },
  {
    name: "OnePlus 10T",
  ...
  },
  {
    ...
    features: ["SusFS", "BBR", "BBG", "TTL", "IP_SET & IPv6NAT", "UnicodeFix", "Droidspaces", "NTSync"],
    osKernels: [
      { os: "Oxygen OS 14", kernel: "android13-5.15.123" },
      { os: "Oxygen OS 15", kernel: "android13-5.15.167" },
      { os: "Oxygen OS 16", kernel: "android13-5.15.180" },
    ],
  },
  {
    name: "OnePlus 11R",
  ...
  },
  {
    ...
    features: ["SusFS", "BBR", "BBG", "TTL", "IP_SET & IPv6NAT", "UnicodeFix", "Droidspaces", "NTSync"],
    osKernels: [
      { os: "Oxygen OS 14", kernel: "android14-6.1.57" },
      { os: "Oxygen OS 15", kernel: "android14-6.1.118" },
      { os: "Oxygen OS 16", kernel: "android14-6.1.141" },
    ],
  },
  {
    name: "OnePlus 12R",
  ...
  },
  {
    ...
    features: ["HMBIRD", "SusFS", "BBR", "BBG", "TTL", "IP_SET & IPv6 NAT", "Unicode Fix", "Droidspaces", "NTSync"],
    osKernels: [
      { os: "Oxygen OS 15", kernel: "android15-6.6.56" },
      { os: "Oxygen OS 16", kernel: "android15-6.6.89" },
    ],
  },
  {
    ...
    features: ["HMBIRD", "SusFS", "BBR", "BBG", "TTL", "IP_SET & IPv6 NAT", "Unicode Fix", "Droidspaces", "NTSync"],
    osKernels: [
      { os: "Oxygen OS 15", kernel: "android15-6.6.66" },
      { os: "Oxygen OS 16", kernel: "android15-6.6.89" },
    ],
  },
  {
  ...
  const filteredDevices = useMemo(() => {
    ...
    return devices.filter((device) => {
      const searchableText = [
        ...
        device.rom ?? "",
        device.features ?? "",
        device.osKernels?.map(ok => `${ok.os} ${ok.kernel}`).join(" ") || "",
      ]
        .join(" ")
        .toLowerCase()
                    ...
                    {device.osKernels && (
                      <div className="mb-4">
                        ...
                        <ul className="space-y-1 text-xs text-muted-foreground">
                          {device.osKernels.map((item) => (
                            <li key={`${item.os}-${item.kernel}`} className="flex justify-between gap-4">
                              <span className="font-medium text-slate-200">{item.os}</span>
